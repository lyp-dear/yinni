<template>
  <div class="tab-head">
    ...
    <div class="top-tabs">
      <van-tabs v-model="active" :class="{'tab3':tabs.length>2&&tabs.length<=3,'tab4':tabs.length>3}" @click="itemClick">
...
export default {
  ...
  created() {
    // this.active = this.$route.path == '/position' ? this.positionType : this.couponType
