...
export default {
  ...
  methods: {
    ...
    getRule() {
      let gameSymbol = this.$route.query.gameCode || this.getcurrentGame.gameSymbol
      let params = {
        gameCode: gameSymbol,
        symbol: 'Game',
        page: 1,
      ...
      let lang = this.$route.query.locale ? this.$route.query.locale : localStorage.getItem('locale') || 'en'
