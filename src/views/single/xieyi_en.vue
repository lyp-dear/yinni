<template>
  <div class="xieyi">
    ...
    <p>
      ...
      (hereinafter referred to as "terms"), all applicable laws and regulations,
      and agree that you are responsible for complying with any applicable local
      laws, whether you are a visitor to the website or a registered member. The
      use of cryptocurrency in some jurisdictions may be illegal, and you are
      responsible for understanding the regulatory requirements for
      cryptocurrency transactions in your jurisdiction before using the service.
      The material contained herein is protected by applicable copyright and
      trademark laws. We can modify these terms at any time by updating this
      page on our website, and you are responsible for regularly reviewing any
      updates to the terms of this website. This agreement also constitutes the
      complete and sole agreement between us and you, and replaces all previous
      or contemporaneous agreements, statements, and statements regarding this
      website and the content, products or services provided by or through this
      website and the subject of this agreement. Guarantee and understanding.
      When you accept this agreement, it means that you are over 18 He is one
      year old and has the legal ability to sign contracts. Acceptance means
      that you agree to each provision of this agreement. If you do not agree to
      all terms, please do not visit or use this website. You specify that you
      are at least over 18 Years old and legally able to sign contracts.
      Acceptance means that you agree to each provision of this agreement. If
      you do not agree to all terms, please do not visit or use this website.
      You specify that you are at least over 18 Years old and legally able to
      sign contracts. Acceptance means that you agree to each provision of this
      agreement. If you do not agree to all terms, please do not visit or use
      this website.
    </p>
    <p class="title">
      3. Revision
    ...
    <p>
      ...
      invalid or unenforceable for any reason, the clause shall be deemed
    ...
    <p>
      ...
      cryptocurrency prices and the time period required to complete the
      transaction, any price or rate of any supported cryptocurrency appearing
      on the website is only accurate at that moment.
    </p>
    <p class="title">
    ...
    <p>
      When registering, users must clearly state and guarantee:<br />
       Fully capable of accepting and accepting the terms and conditions of
      these terms of use, and capable of conducting transactions involving
      cryptocurrency;<br />
       Live in an area where the use and exchange of cryptocurrency is
      allowed;<br />
    ...
    <p>
      You can terminate your user account at any time by sending an email to
    ...
    <p class="title">9. No waiver</p>
    <p>
      These terms shall be governed by Estonian law and interpreted in
      accordance with Estonian law, regardless of conflicts in its legal
      provisions. Our failure to exercise or enforce any rights should not be
      considered a waiver of such rights. Our waiver of violations of these
      terms of use or privacy policy shall not waive any other provisions, nor
      shall it be a waiver of subsequent violations of the same provisions.
    </p>
    ...
    <p>
      ...
      incidental, punitive, special, consequential or punitive damages resulting
      from the use or inability to use this website or website materials or your
      use of this website are obtained from this website, even if the company
      has been notified of such damages possibility. In any case, the company or
      any of its predecessors and successors’ parent companies, subsidiaries,
      affiliates, executives, directors, shareholders, investors, employees,
      agents, representatives and lawyers and their respective heirs, successors
      and The assignee is fully responsible for all damages, losses and
      litigation caused by your contract, tort (including but not limited to) or
      negligence. You pay for the use of this website. Some jurisdictions may
      not allow the exclusion of implied warranties, in which case some of the
      above exclusions may not apply to all users. For the avoidance of doubt,
      we do not assume any responsibility for third-party transactions. Any
      claims regarding such third-party transactions should only be directed
      against the relevant third party. Negligence) or otherwise exceed the
      amount you paid for using this website. Some jurisdictions may not allow
      the exclusion of implied warranties, in which case some of the above
      exclusions may not apply to all users. For the avoidance of doubt, we do
      not assume any responsibility for third-party transactions. Any claims
      regarding such third-party transactions should only be directed against
      the relevant third party. Negligence) or otherwise exceed the amount you
      paid for using this website. Some jurisdictions may not allow the
      exclusion of implied warranties, in which case some of the above
      exclusions may not apply to all users. For the avoidance of doubt, we do
      not assume any responsibility for third-party transactions. Any claims
      regarding such third-party transactions should only be directed against
    ...
    <p class="title">14. Copyright and Intellectual Property</p>
    <p>
      ...
      other means). With the prior written permission of us or the copyright
      owner. Only if you do not modify the material and retain all copyrights
      and other proprietary notices contained in the material, you are allowed
      to download a copy of the material on this website on a computer for your
      personal or internal business use. If you violate these terms, this
      license will terminate immediately. Without our express written
      permission, you may not "mirror" any material contained in this website.
      Any unauthorized use of the materials contained in this website may
      ...
      any intellectual property rights related to any content. This does not
      restrict you from obtaining the explicit permission of its owner or other
    ...
    <p>
      If it is determined that a certain provision of these terms is not
      enforceable in any respect, the enforceability of the provision in any
      other respects and the remaining provisions of these terms or any
      additional agreements will not be impaired.
    </p>
    ...
    <p>
      ...
      You acknowledge that online fiat-to-cryptocurrency and crypto-to-fiat
      ...
      fiduciary responsibility for our relationship with you.
    </p>
    ...
    <p>
      This website and all website materials on it are distributed "as is"
      without any form of guarantee. To the maximum extent permitted by
      applicable laws, the company does not provide any express or implied
      guarantees, including but not limited to implied guarantees of
      merchantability, suitability for specific purposes and purposes.
      Specifically, but not limited to, we do not guarantee: (1) The information
      on this website is correct, accurate or reliable; (2) The functions
      contained in this website will be uninterrupted or error-free; or (3) The
      defect will be corrected, or the website or the server that makes it
      available is free of viruses or other harmful components. You hereby
      acknowledge that the use of this website is at your own risk.
    </p>
    ...
    <p>
      ...
      accordance with the rules adopted by the Estonian Arbitration Association
      when making claims against arbitrators. The arbitration will be conducted
      ...
      clauses will still be fully effective.
    </p>
  </div>
</template>
