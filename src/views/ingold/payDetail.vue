    ...
    <div class="charge-info">
      ...
      <ul>
        <li class="no-border" v-if="payData.amount">
          ...
          <div type="hollow" class="button" 　v-clipboard:copy="payData.amount" 　　v-clipboard:success="copy">
            {{ $t("payDetail.text3") }}
          </div>
        </li>
        <li class="mini">
        ...
        <li>
          ...
          <div type="hollow" class="button" 　v-clipboard:copy="payData.xingming" 　　v-clipboard:success="copy">
            {{ $t("payDetail.text3") }}
          </div>
        </li>
        <li>
          ...
          <div type="hollow" class="button" 　v-clipboard:copy="payData.bank" 　　v-clipboard:success="copy">
            {{ $t("payDetail.text3") }}
          </div>
        </li>
        <li>
          ...
          <div type="hollow" class="button" 　v-clipboard:copy="payData.bank_no" 　　v-clipboard:success="copy">
            {{ $t("payDetail.text3") }}
          </div>
        ...
        <li v-if="payData.bankofdeposit">
          ...
          <div type="hollow" class="button" 　v-clipboard:copy="payData.bankofdeposit" 　　v-clipboard:success="copy">
            {{ $t("payDetail.text3") }}
          </div>
        </li>
        <li v-if="payData.postscript && payData.postscript != ''">
          ...
          <div type="hollow" class="button" 　v-clipboard:copy="payData.postscript" 　　v-clipboard:success="copy">
            {{ $t("payDetail.text3") }}
          </div>
        </li>
