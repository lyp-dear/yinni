export const problemData = [
  {
    titleEn: '1: What do I need to register an account? ',
    contentEn:
      'You can use your own email or mobile phone number to register. In order to protect your privacy, we recommend using email to register. ',
    isOpen: false,
  },
  {
    titleEn: '2: Is there a mobile app? ',
    contentEn:
      'Of course there is! You can download our app to your mobile device, and work will not be restricted at any time and any place. ',
    isOpen: false,
  },
  {
  ...
  {
    titleEn: '5: How can I make money? ',
    contentEn: `When you complete the pledge to become an OTC star-rated merchant, you will get redemption opportunities every day, and you will get benefits every time you redeem. Different levels of OTC merchants have different single exchange limits and single exchange income. Each user can pledge multiple times to get more exchange opportunities and earn more income every day. `,
    isOpen: false,
  },
  {
  ...
  {
    titleEn: '10: Why pay personal income tax? ',
    contentEn:
      'Any legal personal income needs to pay personal income tax. We formulate the proportion of personal income tax according to the individual tax standards in different regions. ',
    isOpen: false,
  },
  {
  ...
  {
    titleEn: `12: Can my earnings be withdrawn? `,
    contentEn: `Your income can be withdrawn at any time within the specified withdrawal time, and each withdrawal amount will reach your designated withdrawal account on the same day. `,
    isOpen: false,
  },
  {
